...
public class CafeteriaService {
    ...
    public void crawlling() throws IOException {
        // 크롤링한 가게 저장
        ...
        for (Element element : elements) {
            ...
            String cuisine = element.select("span.rllt__details").text();
